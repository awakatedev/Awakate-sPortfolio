...
function Home() {
  return (
    <>
      ...
      <main className=" h-full min-h-[660px] flex-col justify-center bg-Mhero-img bg-cover bg-fixed bg-center bg-no-repeat  md:px-20 px-5 md:bg-Dhero-img z-1">
        <Hero />
        <div className='w-full flex items-center justify-start '>
          <StyledTag
            type="p"
            additionalStyle="mt-10 mb-60  text-left w-full md:w-2/4"
          >
        ...
        {/* <section className="flex w-full flex-col items-center z-100">
          <StyledTag
            type="p"
